...
<!-- TERMINAL DE BOOT -->
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=600&size=22&duration=2800&pause=900&color=FF9ACB&center=true&vCenter=true&multiline=true&repeat=true&width=650&height=100&lines=%3E+inicializando+sistema.laura...;%3E+carregando+m%C3%B3dulos%3A+Java+%7C+Python+%7C+C;%3E+status%3A+ONLINE+%F0%9F%8C%B8;%3E+bem-vinda(o)+ao+meu+perfil+%E2%9C%A8" alt="Typing SVG" />
...
```yaml
laura:
  identidade: "Desenvolvedora Backend em formação"
  curso: "Ciência da Computação"
  progresso_academico: "2º / 8º período"
...
<img src="https://raw.githubusercontent.com/catppuccin/catppuccin/main/assets/palette/circle.png" width="100"/>

<br/>

**"Debugando a vida, uma linha de cada vez"** 🎀
...
<!-- PROJETOS EM CARDS -->
## 🎀 <code>~/projetos_em_destaque</code>
...
<!-- OBJETIVOS EM FORMATO TERMINAL -->
## 🌸 <code>~/objetivos_atuais</code>

```bash
laura@dev-mode:~$ cat objetivos.txt

[✓] Dominar lógica de programação com Python
[✓] Consolidar orientação a objetos com Java
[■■■■■■□□□□] 60%  Aprofundar Java para Backend (Spring Boot)
[■■■□□□□□□□] 30%  Estudar fundamentos de C
[■■■■□□□□□□] 40%  Estruturas de Dados & Algoritmos
[■■□□□□□□□□] 20%  Bancos de Dados relacionais e não relacionais
[ ]           Contribuir com projetos open source
[ ]           Conquistar primeira vaga como Dev Backend

laura@dev-mode:~$ echo "sempre em evolução 🌷✨"
> sempre em evolução 🌷✨
laura@dev-mode:~$ _
```
...
<!-- GITHUB STATS -->
## 🩵 <code>~/estatisticas_do_sistema</code>
...
### 💌 <i>"Cada erro de compilação é só mais um passo pra perfeição"</i>

<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=500&size=16&duration=3500&pause=1000&color=C8A2FF&center=true&vCenter=true&width=550&lines=obrigada+por+visitar+meu+perfil+%F0%9F%8C%B8;encerrando+sess%C3%A3o...+at%C3%A9+logo!+%F0%9F%92%97" alt="Footer Typing SVG" />

<br/>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:C8A2FF,50:FF9ACB,100:FFB6D9&height=120&section=footer" width="100%"/>
